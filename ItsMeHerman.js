...
//━━━━━━━━━━━━━━━[ SETTING ]━━━━━━━━━━━━━━━━━//
owner = '6285254354766'//Ganti No Lu
botname = 'Ndex Bot'//Ganti Nama Bot Lu
zerokey = 'ZeroYT7'//Jangan Di Ganti
ownername = 'Ndex Gans'//ganti Nama Lu
//━━━━━━━━━━━━━━━[ MODUL EXPORTS ]━━━━━━━━━━━━━━━━━//
...
module.exports = zeroyt7 = async (zeroyt7, mek, _welkom) => {
	try {
		...
		const ownerNumber = [`${owner}@s.whatsapp.net`, `6285254354766@s.whatsapp.net`]
...
"body": `hy`, 
"mediaType": "2", 
"mediaUrl": "https://github.com/avv-sesad", 
...
switch (command) {
	case 'menu':
	teks = `Hai Kak ${pushname} 👋 ${tampilUcapan}
🍃 *Grup* : ${groupName}
🧐 *Prefix* : Multi Prefix
📜 *Total Fitur* : 110
🔭 *Lib* : Baileys
...
trans = `Gunakan Ndex Bot Dengan Bijak!`
...
+ 'END:VCARD'.trim()
zeroyt7.sendMessage(from, {displayName: `${ownername}`, vcard: vcard2}, contact, 
{ quoted: ftrol, 
})
...
zeroyt7.sendMessage(`6285254354766@s.whatsapp.net`, options, text, { quoted: ftrol })
...
sendButton(from, "GOPAY : 085254354766", faketeks, but, mek)
break
case 'dana':
but = [
{ buttonId: `${prefix}done`, buttonText: { displayText: 'DONE' }, type: 1 }
